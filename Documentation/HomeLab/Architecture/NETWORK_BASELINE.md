...
Phase 11.5 validated adapter mapping, Netplan configuration, routing, DNS, and separate production
versus management naming.

## Operating Rule

Before joining clients or adding new services, validate IP address, DNS, gateway, and domain
resolution.
