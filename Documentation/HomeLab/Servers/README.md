...
Server-specific notes may also live under `../../Server_Documentation/` when a folder already exists
for the host.

For each server, record objective, configuration steps, validation commands, screenshots or
command-output summaries, problems encountered, rollback plan, lessons learned, and interview
relevance.
