...
Large binaries are stored locally for lab use but ignored by Git. Commit this inventory, not the
binaries.
...
These tools were detected on the workstation and do not need duplicate local installer downloads
yet:
